...
import {
  ...
  useGLTF,
  useKeyboardControls
} from "./chunk-C5T2EWC5.js";
import {
  create
} from "./chunk-W3WQN2QJ.js";
import "./chunk-R4VF2JDJ.js";
import {
  CapsuleCollider,
  CylinderCollider,
  RigidBody,
...
import "./chunk-OXGEOA3Y.js";
import "./chunk-I7AN2CCH.js";
import {
  Canvas,
  addEffect,
  applyProps,
...
var require_get_value = __commonJS({
  "node_modules/get-value/index.js"(exports, module) {
    module.exports = function(obj, prop, a4, b4, c6) {
...
var $ = (e4, t4, r4, n4, i4) => {
  ...
  const a4 = (e5, t5, r5) => {
    ...
    const p4 = (e6) => {
      for (c6 in e6) {
        const R3 = 64 === c6.charCodeAt(0), z2 = R3 && Array.isArray(e6[c6]) ? e6[c6] : [e6[c6]];
        for (g4 of z2) {
          const e7 = /[A-Z]/.test($4 = c6) ? $4 : $4.replace(/-[^]/g, (e8) => e8[1].toUpperCase()), z3 = "object" == typeof g4 && g4 && g4.toString === B && (!n4.utils[e7] || !t5.length);
          ...
          if (R3 && (b4 = c6.slice(1) in n4.media ? "@media " + n4.media[c6.slice(1)] : c6, c6 = b4.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (e8, t6, r6, n5, i5, o5) => {
            const l5 = h.test(t6), s5 = 0.0625 * (l5 ? -1 : 1), [a5, c7] = l5 ? [n5, t6] : [t6, n5];
            return "(" + ("=" === r6[0] ? "" : ">" === r6[0] === l5 ? "max-" : "min-") + a5 + ":" + ("=" !== r6[0] && 1 === r6.length ? c7.replace(h, (e9, t7, n6) => Number(t7) + s5 * (">" === r6 ? 1 : -1) + n6) : c7) + (i5 ? ") and (" + (">" === i5[0] ? "min-" : "max-") + a5 + ":" + (1 === i5.length ? o5.replace(h, (e9, t7, r7) => Number(t7) + s5 * (">" === i5 ? -1 : 1) + r7) : o5) : "") + ")";
          })), z3) {
            const e8 = R3 ? r5.concat(c6) : [...r5], n5 = R3 ? [...t5] : f(t5, c6.split(y));
            void 0 !== o4 && i4(x(...o4)), o4 = void 0, a4(g4, n5, e8);
          } else void 0 === o4 && (o4 = [[], t5, r5]), c6 = R3 || 36 !== c6.charCodeAt(0) ? c6 : `--${S(n4.prefix)}${c6.slice(1).replace(/\$/g, "-")}`, g4 = z3 ? g4 : "number" == typeof g4 ? g4 && e7 in I ? String(g4) + "px" : String(g4) : k(m(e7, null == g4 ? "" : g4), n4.prefix, n4.themeMap[e7]), o4[0].push(`${R3 ? `${c6} ` : `${d(c6)}:`}${g4}`);
        }
      }
      var b4, $4;
    };
  ...
  const r4 = () => {
    ...
    for (const e5 of i4) if (j(e5)) {
      for (let i5 = 0, o5 = e5.cssRules; o5[i5]; ++i5) {
        ...
        const c6 = a4.slice(14, -3).trim().split(/\s+/), d4 = W[c6[0]];
        d4 && (t4 || (t4 = { sheet: e5, reset: n4, rules: {}, toString: r4 }), t4.rules[d4] = { group: s4, index: i5, cache: new Set(c6) });
      }
      if (t4) break;
    }
    if (!t4) {
...
var P = (e4, t4, r4) => {
  const [n4, i4, o4, a4] = L(t4.composers), c6 = "function" == typeof t4.type || t4.type.$$typeof ? ((e5) => {
    function t5() {
  ...
  })(r4) : null, d4 = (c6 || r4).rules, g4 = `.${n4}${i4.length > 1 ? `:where(.${i4.slice(1).join(".")})` : ""}`, p4 = (l4) => {
    ...
    return { type: t4.type, className: f4, selector: g4, props: p5, toString: () => f4, deferredInjector: c6 };
  };
...
var O = (e4, t4, r4, n4) => {
  ...
  e: for (let [o4, l4, s4] of e4) {
        ...
        if ("object" != typeof i5 || !i5) continue e;
        {
          ...
          for (const l5 in i5) {
            if (n5 === String(i5[l5])) {
              if ("@initial" !== l5) {
                const e7 = l5.slice(1);
                (t5 = t5 || []).push(e7 in r4 ? r4[e7] : l5.replace(/^@media ?/, "")), c6 = true;
              }
              a4 += o5, e6 = true;
            }
            ++o5;
    ...
    (i4[a4] = i4[a4] || []).push([n4 ? "cv" : `${e5}-${o4[e5]}`, l4, c6]);
  }
  return i4;
};
var A = {};
...
var sanitizeStep$1 = (v4, {
  ...
  const steps2 = Math.round((v4 - initialValue) / step);
  return initialValue + steps2 * step;
};
...
function ValueInput(_ref) {
  ...
  const update3 = (0, import_react3.useCallback)((fn) => (event) => {
    const _value = event.currentTarget.value;
    fn(_value);
  }, []);
  import_react3.default.useEffect(() => {
    const ref = inputRef.current;
    const _onUpdate = update3((value2) => {
      onUpdate(value2);
      emitOnEditEnd();
    });
  ...
  }, [update3, onUpdate, emitOnEditEnd]);
  const onKeyPress = (0, import_react3.useCallback)((event) => {
    if (event.key === "Enter") {
      update3(onUpdate)(event);
    }
  }, [update3, onUpdate]);
...
function useCanvas2d(fn) {
  ...
  const ctx2 = (0, import_react3.useRef)(null);
  ...
  (0, import_react3.useEffect)(() => {
    const handleCanvas = debounce(() => {
      ...
      fn(canvas.current, ctx2.current);
    }, 250);
  ...
  (0, import_react3.useEffect)(() => {
    ctx2.current = canvas.current.getContext("2d");
  }, []);
  return [canvas, ctx2];
}
...
function names_default(e4, f4) {
  ...
  e4.prototype.toName = function(f5) {
    ...
    if (null == f5 ? void 0 : f5.closest) {
      ...
      if (!l4.length) for (var c6 in a4) l4[c6] = new e4(a4[c6]).toRgb();
      for (var g4 in a4) {
...
var I3 = function(e4) {
  ...
  var a4 = Math.floor(r4), l4 = n4 * (1 - t4), u4 = n4 * (1 - (r4 - a4) * t4), c6 = n4 * (1 - (1 - r4 + a4) * t4), i4 = a4 % 6;
  return { r: b3(255 * [n4, u4, l4, l4, c6, n4][i4]), g: b3(255 * [c6, n4, n4, u4, l4, l4][i4]), b: b3(255 * [l4, l4, c6, n4, n4, u4][i4]), a: b3(o4, 2) };
};
var L2 = function(e4) {
...
function Y2(e4, t4, l4) {
  var u4 = i3(l4), c6 = (0, import_react6.useState)(function() {
    return e4.toHsva(t4);
  }), s4 = c6[0], f4 = c6[1], v4 = (0, import_react6.useRef)({ color: t4, hsva: s4 });
...
function create2(createState) {
  ...
  const useStore = (selector = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react8.useReducer)((c6) => c6 + 1, 0);
...
function useDeepMemo(fn, deps) {
  return (0, import_react9.useMemo)(fn, useCompareMemoize(deps, true));
}
...
function Color({
  ...
  }), shown && import_react9.default.createElement(Portal2, null, import_react9.default.createElement(Overlay, {
...
function Joystick({
  ...
  return import_react9.default.createElement(JoystickTrigger, _extends({
    ref: joystickeRef
  }, bind()), joystickShown && import_react9.default.createElement(Portal2, null, import_react9.default.createElement(JoystickPlayground, {
    ref: playgroundRef,
    isOutOfBounds
...
function ImageComponent() {
  ...
  }), shown && !!value && import_react9.default.createElement(Portal2, null, import_react9.default.createElement(Overlay, {
    onPointerUp: hide4,
    style: {
      cursor: "pointer"
    }
...
var MonitorCanvas = (0, import_react9.forwardRef)(function({
  ...
  const raf2 = (0, import_react9.useRef)();
  ...
  const [canvas, ctx2] = useCanvas2d(drawPlot);
  (0, import_react9.useImperativeHandle)(ref, () => ({
    frame: (val) => {
      ...
      raf2.current = requestAnimationFrame(() => drawPlot(canvas.current, ctx2.current));
    }
  }), [canvas, ctx2, drawPlot]);
  (0, import_react9.useEffect)(() => () => cancelAnimationFrame(raf2.current), []);
  return import_react9.default.createElement(Canvas2, {
    ref: canvas
  });
});
...
var LevaCore = import_react9.default.memo(({
  ...
  globalStyles();
  return import_react9.default.createElement(PanelSettingsContext.Provider, {
    value: {
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react9.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
...
// node_modules/ecctrl/node_modules/@react-spring/rafz/dist/react-spring_rafz.modern.mjs
...
raf.setTimeout = (handler, ms) => {
  ...
  const cancel = () => {
    const i4 = timeouts.findIndex((t4) => t4.cancel == cancel);
    if (~i4)
...
function update() {
  ...
  if (count2) {
    eachSafely(timeouts.splice(0, count2), (t4) => t4.handler());
    pendingCount -= count2;
  }
  if (!pendingCount) {
    stop();
...
var clamp3 = (min2, max2, v4) => Math.min(Math.max(v4, min2), max2);
var colors2 = {
  transparent: 0,
...
function hslToRgb(h4, s4, l4) {
  ...
  const p4 = 2 * l4 - q3;
  const r4 = hue2rgb(p4, q3, h4 + 1 / 3);
  const g4 = hue2rgb(p4, q3, h4);
  const b4 = hue2rgb(p4, q3, h4 - 1 / 3);
...
var easings = {
  ...
  easeInBack: (x3) => c32 * x3 * x3 * x3 - c1 * x3 * x3,
  easeOutBack: (x3) => 1 + c32 * Math.pow(x3 - 1, 3) + c1 * Math.pow(x3 - 1, 2),
...
function isAnimatedString(value) {
  ...
  !isSSR2() && cssVariableRegex.test(value) || value in (colors || {}));
}
var useIsomorphicLayoutEffect2 = isSSR2() ? import_react15.useEffect : import_react15.useLayoutEffect;
var useIsMounted = () => {
...
function useForceUpdate() {
  const update3 = (0, import_react13.useState)()[1];
...
function useMemoOne(getResult, inputs) {
  const [initial] = (0, import_react16.useState)(
    () => ({
      inputs,
      result: getResult()
    })
  );
  const committed = (0, import_react16.useRef)();
...
var useOnce = (effect) => (0, import_react17.useEffect)(effect, emptyDeps);
var emptyDeps = [];
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react20.forwardRef)((givenProps, givenRef) => {
    const instanceRef = (0, import_react20.useRef)(null);
    ...
    const [props3, deps] = getAnimatedState(givenProps, host2);
    ...
    const callback = () => {
      ...
      const didUpdate = instance ? host2.applyAnimatedValues(instance, props3.getValue(true)) : false;
      if (didUpdate === false) {
        forceUpdate();
      }
    };
    const observer = new PropsObserver(callback, deps);
    const observerRef = (0, import_react20.useRef)();
    useIsomorphicLayoutEffect2(() => {
    ...
    (0, import_react20.useEffect)(callback, []);
    useOnce(() => () => {
      const observer2 = observerRef.current;
      each(observer2.deps, (dep) => removeFluidObserver(dep, observer2));
    });
    const usedProps = host2.getComponentProps(props3.getValue());
    return React23.createElement(Component, { ...usedProps, ref });
  });
};
...
function getAnimatedState(props3, host2) {
  const dependencies = /* @__PURE__ */ new Set();
  TreeContext.dependencies = dependencies;
  if (props3.style)
    props3 = {
      ...props3,
      style: host2.createAnimatedStyle(props3.style)
    };
  props3 = new AnimatedObject(props3);
  TreeContext.dependencies = null;
  return [props3, dependencies];
}
...
var createHost = (components, {
  ...
  getComponentProps = (props3) => props3
} = {}) => {
  const hostConfig = {
    applyAnimatedValues,
    createAnimatedStyle,
...
var getDefaultProp = (props3, key) => props3.default === true ? props3[key] : props3.default ? props3.default[key] : void 0;
var noopTransform = (value) => value;
var getDefaultProps = (props3, transform = noopTransform) => {
  let keys = DEFAULT_PROPS;
  if (props3.default && props3.default !== true) {
    props3 = props3.default;
    keys = Object.keys(props3);
  }
  const defaults2 = {};
  for (const key of keys) {
    const value = transform(props3[key], key);
    if (!is.und(value)) {
      defaults2[key] = value;
    }
  }
...
function getForwardProps(props3) {
  const forward = {};
  let count2 = 0;
  eachProp(props3, (value, prop) => {
...
function inferTo(props3) {
  const to2 = getForwardProps(props3);
  if (to2) {
    const out = { to: to2 };
    eachProp(props3, (val, key) => key in to2 || (out[key] = val));
    return out;
  }
  return { ...props3 };
}
...
function hasProps(props3) {
  for (const _2 in props3)
    return true;
  return false;
}
...
function sanitizeConfig(config2, props3) {
  if (!is.und(props3.decay)) {
    config2.duration = void 0;
  } else {
    const isTensionConfig = !is.und(props3.tension) || !is.und(props3.friction);
    if (isTensionConfig || !is.und(props3.frequency) || !is.und(props3.damping) || !is.und(props3.mass)) {
      config2.duration = void 0;
...
function scheduleProps(callId, { key, props: props3, defaultProps: defaultProps2, state, actions }) {
  return new Promise((resolve, reject) => {
    let delay;
    let timeout;
    let cancel = matchProp(props3.cancel ?? (defaultProps2 == null ? void 0 : defaultProps2.cancel), key);
    if (cancel) {
      onStart();
    } else {
      if (!is.und(props3.pause)) {
        state.paused = matchProp(props3.pause, key);
      }
      let pause = defaultProps2 == null ? void 0 : defaultProps2.pause;
      if (pause !== true) {
        pause = state.paused || matchProp(pause, key);
      }
      delay = callProp(props3.delay || 0, key);
      if (pause) {
    ...
    function onStart() {
      ...
      try {
        actions.start({ ...props3, callId, cancel }, resolve);
      } catch (err) {
        reject(err);
      }
    }
...
function runAsync(to2, props3, state, target) {
  const { callId, parentId, onRest } = props3;
  const { asyncTo: prevTo, promise: prevPromise } = state;
  if (!parentId && to2 === prevTo && !props3.reset) {
    return prevPromise;
  }
  return state.promise = (async () => {
    ...
    const animate = (arg1, arg2) => {
      ...
      return (async () => {
        ...
        const props22 = is.obj(arg1) ? { ...arg1 } : { ...arg2, to: arg1 };
        props22.parentId = callId;
        eachProp(defaultProps2, (value, key) => {
          if (is.und(props22[key])) {
            props22[key] = value;
          }
        });
        const result2 = await target.start(props22);
        bailIfEnded(bailSignal);
        if (state.paused) {
...
var SpringValue = class extends FrameValue {
  constructor(arg1, arg2) {
    ...
    if (!is.und(arg1) || !is.und(arg2)) {
      const props3 = is.obj(arg1) ? { ...arg1 } : { ...arg2, from: arg1 };
      if (is.und(props3.default)) {
        props3.default = true;
      }
      this.start(props3);
    }
  ...
  _update({ ...props3 }, isLoop) {
    ...
    mergeActiveFn(this, props3, "onProps");
    sendEvent(this, "onProps", props3, this);
    const range2 = this._prepareNode(props3);
    ...
    return scheduleProps(++this._lastCallId, {
      ...
      if (props3.loop && result.finished && !(isLoop && result.noop)) {
        const nextProps = createLoopUpdate(props3);
        if (nextProps) {
  ...
  _merge(range2, props3, resolve) {
    ...
    if (hasToProp || hasFromProp) {
      if (props3.callId > this._lastToId) {
        this._lastToId = props3.callId;
      } else {
        return resolve(getCancelledResult(this));
      }
    }
    ...
    if (hasFromProp && !hasToProp && (!props3.default || is.und(to2))) {
      to2 = from;
    }
    if (props3.reverse)
      [to2, from] = [from, to2];
    ...
    const hasAsyncTo = isAsyncTo(props3.to);
    const { config: config2 } = anim;
    const { decay, velocity } = config2;
    if (hasToProp || hasFromProp) {
      config2.velocity = 0;
    }
    if (props3.config && !hasAsyncTo) {
      mergeConfig(
        config2,
        callProp(props3.config, key),
        // Avoid calling the same "config" prop twice.
        props3.config !== defaultProps2.config ? callProp(defaultProps2.config, key) : void 0
      );
    }
    ...
    const reset = (
      ...
      is.und(props3.reset) ? hasFromProp && !props3.default : !is.und(from) && matchProp(props3.reset, key)
    );
    const value = reset ? from : this.get();
    const goal = computeGoal(to2);
    const isAnimatable = is.num(goal) || is.arr(goal) || isAnimatedString(goal);
    const immediate = !hasAsyncTo && (!isAnimatable || matchProp(defaultProps2.immediate || props3.immediate, key));
    if (hasToChanged) {
    ...
    if (!hasAsyncTo) {
      ...
      if (started) {
        const { onRest } = anim;
        each(ACTIVE_EVENTS, (type) => mergeActiveFn(this, props3, type));
    ...
    if (hasAsyncTo) {
      resolve(runAsync(props3.to, props3, this._state, this));
    } else if (started) {
      this._start();
...
function createLoopUpdate(props3, loop2 = props3.loop, to2 = props3.to) {
  const loopRet = callProp(loop2);
  if (loopRet) {
    const overrides = loopRet !== true && inferTo(loopRet);
    const reverse = (overrides || props3).reverse;
...
function createUpdate(props3) {
  const { to: to2, from } = props3 = inferTo(props3);
  const keys = /* @__PURE__ */ new Set();
  if (is.obj(to2))
    findDefined(to2, keys);
  if (is.obj(from))
    findDefined(from, keys);
  props3.keys = keys.size ? Array.from(keys) : null;
  return props3;
}
function declareUpdate(props3) {
  const update22 = createUpdate(props3);
...
function mergeActiveFn(target, props3, type) {
  target.animation[type] = props3[type] !== getDefaultProp(props3, type) ? resolveProp(props3[type], target.key) : void 0;
}
...
var Controller = class {
  constructor(props3, flush3) {
    ...
    if (props3) {
      this.start({ default: true, ...props3 });
    }
  }
  /**
  ...
  update(props3) {
    if (props3) {
      this.queue.push(createUpdate(props3));
    }
    return this;
  }
  /**
  ...
  start(props3) {
    let { queue } = this;
    if (props3) {
      queue = toArray(props3).map(createUpdate);
    } else {
      this.queue = [];
    }
    if (this._flush) {
...
function flushUpdateQueue(ctrl, queue) {
  return Promise.all(queue.map((props3) => flushUpdate(ctrl, props3))).then(
    (results) => getCombinedResult(ctrl, results)
  );
}
async function flushUpdate(ctrl, props3, isLoop) {
  const { keys, to: to2, from, loop: loop2, onRest, onResolve } = props3;
  const defaults2 = is.obj(props3.default) && props3.default;
  if (loop2) {
    props3.loop = false;
  }
  if (to2 === false)
  ...
  if (asyncTo) {
    props3.to = void 0;
    props3.onRest = void 0;
    if (defaults2) {
      defaults2.onRest = void 0;
    }
  } else {
    each(BATCHED_EVENTS, (key) => {
      const handler = props3[key];
      if (is.fun(handler)) {
        const queue = ctrl["_events"][key];
        props3[key] = ({ finished, cancelled }) => {
        ...
        if (defaults2) {
          defaults2[key] = props3[key];
        }
      }
    });
  }
  const state = ctrl["_state"];
  if (props3.pause === !state.paused) {
    state.paused = props3.pause;
    flushCalls(props3.pause ? state.pauseQueue : state.resumeQueue);
  } else if (state.paused) {
    props3.pause = true;
  }
  const promises = (keys || Object.keys(ctrl.springs)).map(
    (key) => ctrl.springs[key].start(props3)
  );
  const cancel = props3.cancel === true || getDefaultProp(props3, "cancel") === true;
    ...
    promises.push(
      scheduleProps(++ctrl["_lastAsyncId"], {
        ...
        actions: {
          pause: noop2,
          resume: noop2,
          start(props22, resolve) {
            if (cancel) {
              stopAsync(state, ctrl["_lastAsyncId"]);
              resolve(getCancelledResult(ctrl));
            } else {
              props22.onRest = onRest;
              resolve(
                runAsync(
                  asyncTo,
                  props22,
  ...
  if (loop2 && result.finished && !(isLoop && result.noop)) {
    const nextProps = createLoopUpdate(props3, loop2, to2);
    if (nextProps) {
...
function getSprings(ctrl, props3) {
  ...
  if (props3) {
    each(toArray(props3), (props22) => {
      if (is.und(props22.keys)) {
        props22 = createUpdate(props22);
      }
      if (!is.obj(props22.to)) {
        props22 = { ...props22, to: void 0 };
      }
      prepareSprings(springs, props22, (key) => {
...
function prepareSprings(springs, props3, create3) {
  if (props3.keys) {
    each(props3.keys, (key) => {
      const spring = springs[key] || (springs[key] = create3(key));
      spring["_prepareNode"](props3);
    });
  }
}
function prepareKeys(ctrl, queue) {
  each(queue, (props3) => {
    prepareSprings(ctrl.springs, props3, (key) => {
...
var SpringContext = ({
  ...
  const inherited = (0, import_react22.useContext)(ctx);
  const pause = props3.pause || !!inherited.pause, immediate = props3.immediate || !!inherited.immediate;
  props3 = useMemoOne(() => ({ pause, immediate }), [pause, immediate]);
  const { Provider } = ctx;
  return React24.createElement(Provider, { value: props3 }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React24.createContext(init));
...
var SpringRef = () => {
  const current = [];
  const SpringRef2 = function(props3) {
    deprecateDirectCall();
    const results = [];
    each(current, (ctrl, i4) => {
      if (is.und(props3)) {
        ...
        const update22 = _getProps(props3, ctrl, i4);
        if (update22) {
  ...
  SpringRef2.start = function(props3) {
    const results = [];
    each(current, (ctrl, i4) => {
      if (is.und(props3)) {
        results.push(ctrl.start());
      } else {
        const update22 = this._getProps(props3, ctrl, i4);
        if (update22) {
          results.push(ctrl.start(update22));
        }
      }
  ...
  SpringRef2.update = function(props3) {
    each(current, (ctrl, i4) => ctrl.update(this._getProps(props3, ctrl, i4)));
    return this;
  };
...
function useSprings(length, props3, deps) {
  const propsFn = is.fun(props3) && props3;
  if (propsFn && !deps)
    deps = [];
  const ref = (0, import_react21.useMemo)(
    () => propsFn || arguments.length == 3 ? SpringRef() : void 0,
    []
  );
  const layoutId = (0, import_react21.useRef)(0);
  const forceUpdate = useForceUpdate();
  ...
  const ctrls = (0, import_react21.useRef)([...state.ctrls]);
  const updates = [];
  ...
  function declareUpdates(startIndex, endIndex) {
    for (let i4 = startIndex; i4 < endIndex; i4++) {
      ...
      const update22 = propsFn ? propsFn(i4, ctrl) : props3[i4];
      if (update22) {
  ...
  const context = (0, import_react21.useContext)(SpringContext);
...
function useSpring(props3, deps) {
  const isFn = is.fun(props3);
...
var useFollowCam = function(props3) {
  ...
  const disableFollowCam = props3.disableFollowCam;
  const disableFollowCamPos = props3.disableFollowCamPos;
  const disableFollowCamTarget = props3.disableFollowCamTarget;
  ...
  const camUpLimit = props3.camUpLimit;
  const camLowLimit = props3.camLowLimit;
  const camInitDir = props3.camInitDir;
  ...
  const camListenerTarget = props3.camListenerTarget;
  const pivot = (0, import_react26.useMemo)(() => new Object3D(), []);
  const followCam = (0, import_react26.useMemo)(() => {
  ...
  const cameraRayDir = (0, import_react26.useMemo)(() => new Vector3(), []);
  const cameraRayOrigin = (0, import_react26.useMemo)(() => new Vector3(), []);
  const cameraPosition = (0, import_react26.useMemo)(() => new Vector3(), []);
  const camLerpingPoint = (0, import_react26.useMemo)(() => new Vector3(), []);
...
function EcctrlAnimation(props3) {
  const group = (0, import_react26.useRef)();
  ...
  return import_react26.default.createElement(import_react26.Suspense, { fallback: null }, import_react26.default.createElement("group", { ref: group, dispose: null, userData: { camExcludeCollision: true } }, props3.children));
}
var JoystickComponents = (props3) => {
  ...
  let joystickDis = 0;
  let joystickAng = 0;
  const touch1MovementVec2 = (0, import_react26.useMemo)(() => new Vector2(), []);
  const joystickMovementVec2 = (0, import_react26.useMemo)(() => new Vector2(), []);
  const [windowSize, setWindowSize] = (0, import_react26.useState)({ innerHeight, innerWidth });
  ...
  const joystickBaseGeo = (0, import_react26.useMemo)(() => new CylinderGeometry(2.3, 2.1, 0.3, 16), []);
  const joystickStickGeo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.3, 0.3, 3, 6), []);
  const joystickHandleGeo = (0, import_react26.useMemo)(() => new SphereGeometry(1.4, 8, 8), []);
  const joystickBaseMaterial = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickStickMaterial = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const joystickHandleMaterial = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.7 }), []);
  const setJoystick = useJoystickControls((state) => state.setJoystick);
  const resetJoystick = useJoystickControls((state) => state.resetJoystick);
  const onTouchMove = (0, import_react26.useCallback)((e4) => {
    e4.preventDefault();
    e4.stopImmediatePropagation();
    const touch1 = e4.targetTouches[0];
  ...
  return import_react26.default.createElement(import_react26.Suspense, { fallback: "null" }, import_react26.default.createElement(animated.group, { "position-x": springs.basePositionX, "position-y": springs.basePositionY }, import_react26.default.createElement("mesh", { geometry: joystickBaseGeo, material: joystickBaseMaterial, rotation: [-Math.PI / 2, 0, 0], ...props3.joystickBaseProps })), import_react26.default.createElement(animated.group, { "rotation-x": springs.topRotationX, "rotation-y": springs.topRotationY }, import_react26.default.createElement("mesh", { geometry: joystickStickGeo, material: joystickStickMaterial, rotation: [-Math.PI / 2, 0, 0], position: [0, 0, 1.5], ...props3.joystickStickProps }), import_react26.default.createElement("mesh", { geometry: joystickHandleGeo, material: joystickHandleMaterial, position: [0, 0, 4], ...props3.joystickHandleProps })));
};
var ButtonComponents = ({ buttonNumber = 1, ...props3 }) => {
  const buttonLargeBaseGeo = (0, import_react26.useMemo)(() => new CylinderGeometry(1.1, 1, 0.3, 16), []);
  const buttonSmallBaseGeo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.9, 0.8, 0.3, 16), []);
  const buttonTop1Geo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop2Geo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.9, 0.9, 0.5, 16), []);
  const buttonTop3Geo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop4Geo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonTop5Geo = (0, import_react26.useMemo)(() => new CylinderGeometry(0.7, 0.7, 0.5, 16), []);
  const buttonBaseMaterial = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.3 }), []);
  const buttonTop1Material = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop2Material = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop3Material = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop4Material = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  const buttonTop5Material = (0, import_react26.useMemo)(() => new MeshNormalMaterial({ transparent: true, opacity: 0.5 }), []);
  ...
  return import_react26.default.createElement(import_react26.Suspense, { fallback: "null" }, buttonNumber > 0 && import_react26.default.createElement(
    animated.group,
    {
    ...
    import_react26.default.createElement("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props3.buttonLargeBaseProps, onPointerDown: () => onPointerDown(1) }),
    import_react26.default.createElement("mesh", { geometry: buttonTop1Geo, material: buttonTop1Material, position: [0, -0.3, 0], ...props3.buttonTop1Props })
  ), buttonNumber > 1 && import_react26.default.createElement(
    animated.group,
    {
    ...
    import_react26.default.createElement("mesh", { geometry: buttonLargeBaseGeo, material: buttonBaseMaterial, ...props3.buttonLargeBaseProps, onPointerDown: () => onPointerDown(2) }),
    import_react26.default.createElement("mesh", { geometry: buttonTop2Geo, material: buttonTop2Material, position: [0, -0.3, 0], ...props3.buttonTop2Props })
  ), buttonNumber > 2 && import_react26.default.createElement(
    animated.group,
    {
    ...
    import_react26.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(3) }),
    import_react26.default.createElement("mesh", { geometry: buttonTop3Geo, material: buttonTop3Material, position: [0, -0.3, 0], ...props3.buttonTop3Props })
  ), buttonNumber > 3 && import_react26.default.createElement(
    animated.group,
    {
    ...
    import_react26.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(4) }),
    import_react26.default.createElement("mesh", { geometry: buttonTop4Geo, material: buttonTop4Material, position: [0, -0.3, 0], ...props3.buttonTop4Props })
  ), buttonNumber > 4 && import_react26.default.createElement(
    animated.group,
    {
    ...
    import_react26.default.createElement("mesh", { geometry: buttonSmallBaseGeo, material: buttonBaseMaterial, ...props3.buttonSmallBaseProps, onPointerDown: () => onPointerDown(5) }),
    import_react26.default.createElement("mesh", { geometry: buttonTop5Geo, material: buttonTop5Material, position: [0, -0.3, 0], ...props3.buttonTop5Props })
  ));
};
var EcctrlJoystick = (0, import_react26.forwardRef)((props3, ref) => {
  ...
  return import_react26.default.createElement("div", { ref }, import_react26.default.createElement("div", { id: "ecctrl-joystick", style: joystickWrapperStyle, onContextMenu: (e4) => e4.preventDefault() }, import_react26.default.createElement(
    Canvas,
    {
      shadows: true,
      orthographic: true,
    ...
    import_react26.default.createElement(JoystickComponents, { ...props3 }),
    props3.children
  )), props3.buttonNumber !== 0 && import_react26.default.createElement("div", { id: "ecctrl-button", style: buttonWrapperStyle, onContextMenu: (e4) => e4.preventDefault() }, import_react26.default.createElement(
    Canvas,
    {
      shadows: true,
      orthographic: true,
    ...
    import_react26.default.createElement(ButtonComponents, { ...props3 }),
    props3.children
  )));
});
...
var Ecctrl = ({
  ...
  const characterRef = ref || (0, import_react26.useRef)();
  const characterModelRef = (0, import_react26.useRef)();
  const characterModelIndicator = (0, import_react26.useMemo)(() => new Object3D(), []);
  ...
  const findMode = (mode2, modes) => modes.split(" ").some((m4) => m4 === mode2);
  if (mode) {
  ...
  const modelFacingVec = (0, import_react26.useMemo)(() => new Vector3(), []);
  const bodyFacingVec = (0, import_react26.useMemo)(() => new Vector3(), []);
  const bodyBalanceVec = (0, import_react26.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnX = (0, import_react26.useMemo)(() => new Vector3(), []);
  const bodyFacingVecOnY = (0, import_react26.useMemo)(() => new Vector3(), []);
  const bodyBalanceVecOnZ = (0, import_react26.useMemo)(() => new Vector3(), []);
  const vectorY = (0, import_react26.useMemo)(() => new Vector3(0, 1, 0), []);
  const vectorZ = (0, import_react26.useMemo)(() => new Vector3(0, 0, 1), []);
  const crossVecOnX = (0, import_react26.useMemo)(() => new Vector3(), []);
  const crossVecOnY = (0, import_react26.useMemo)(() => new Vector3(), []);
  const crossVecOnZ = (0, import_react26.useMemo)(() => new Vector3(), []);
  const bodyContactForce = (0, import_react26.useMemo)(() => new Vector3(), []);
  const slopeRayOriginUpdatePosition = (0, import_react26.useMemo)(() => new Vector3(), []);
  const camBasedMoveCrossVecOnY = (0, import_react26.useMemo)(() => new Vector3(), []);
  ...
  const setJoystick = useJoystickControls((state) => state.setJoystick);
  const resetJoystick = useJoystickControls((state) => state.resetJoystick);
  const [controllerIndex, setControllerIndex] = (0, import_react26.useState)(null);
  const gamepadKeys = { forward: false, backward: false, leftward: false, rightward: false };
  const gamepadJoystickVec2 = (0, import_react26.useMemo)(() => new Vector2(), []);
  let gamepadJoystickDis = 0;
  let gamepadJoystickAng = 0;
  const gamepadConnect = (e4) => {
    setControllerIndex(e4.gamepad.index);
  };
  const gamepadDisconnect = () => {
    setControllerIndex(null);
  };
  const mergedKeys = (0, import_react26.useMemo)(() => Object.assign({}, defaultControllerKeys, controllerKeys), [controllerKeys]);
  ...
  let canJump = false;
  let isFalling = false;
  const initialGravityScale = (0, import_react26.useMemo)(() => props3.gravityScale || 1, []);
  let massRatio = 1;
  let isOnMovingObject = false;
  const standingForcePoint = (0, import_react26.useMemo)(() => new Vector3(), []);
  const movingObjectDragForce = (0, import_react26.useMemo)(() => new Vector3(), []);
  const movingObjectVelocity = (0, import_react26.useMemo)(() => new Vector3(), []);
  const movingObjectVelocityInCharacterDir = (0, import_react26.useMemo)(() => new Vector3(), []);
  const distanceFromCharacterToObject = (0, import_react26.useMemo)(() => new Vector3(), []);
  const objectAngvelToLinvel = (0, import_react26.useMemo)(() => new Vector3(), []);
  const velocityDiff = (0, import_react26.useMemo)(() => new Vector3(), []);
  let dirLight = null;
  const cameraSetups = {
    disableFollowCam,
    disableFollowCamPos,
  ...
  const pivotPosition = (0, import_react26.useMemo)(() => new Vector3(), []);
  const followCamPosition = (0, import_react26.useMemo)(() => new Vector3(), []);
  const modelEuler = (0, import_react26.useMemo)(() => new Euler(), []);
  const modelQuat = (0, import_react26.useMemo)(() => new Quaternion(), []);
  const moveImpulse = (0, import_react26.useMemo)(() => new Vector3(), []);
  const movingDirection = (0, import_react26.useMemo)(() => new Vector3(), []);
  const moveAccNeeded = (0, import_react26.useMemo)(() => new Vector3(), []);
  const jumpVelocityVec = (0, import_react26.useMemo)(() => new Vector3(), []);
  const jumpDirection = (0, import_react26.useMemo)(() => new Vector3(), []);
  const currentVel = (0, import_react26.useMemo)(() => new Vector3(), []);
  const currentPos = (0, import_react26.useMemo)(() => new Vector3(), []);
  const dragForce = (0, import_react26.useMemo)(() => new Vector3(), []);
  const dragAngForce = (0, import_react26.useMemo)(() => new Vector3(), []);
  const wantToMoveVel = (0, import_react26.useMemo)(() => new Vector3(), []);
  const rejectVel = (0, import_react26.useMemo)(() => new Vector3(), []);
  let floatingForce = null;
  const springDirVec = (0, import_react26.useMemo)(() => new Vector3(), []);
  const characterMassForce = (0, import_react26.useMemo)(() => new Vector3(), []);
  const rayOrigin = (0, import_react26.useMemo)(() => new Vector3(), []);
  const rayCast = new rapier.Ray(rayOrigin, rayDir);
  let rayHit = null;
  let slopeAngle = null;
  let actualSlopeNormal = null;
  let actualSlopeAngle = null;
  const actualSlopeNormalVec = (0, import_react26.useMemo)(() => new Vector3(), []);
  const floorNormal = (0, import_react26.useMemo)(() => new Vector3(0, 1, 0), []);
  const slopeRayOriginRef = (0, import_react26.useRef)();
  const slopeRayorigin = (0, import_react26.useMemo)(() => new Vector3(), []);
  ...
  const crossVector = (0, import_react26.useMemo)(() => new Vector3(), []);
  const pointToPoint = (0, import_react26.useMemo)(() => new Vector3(), []);
  const getMoveToPoint = useGame((state) => state.getMoveToPoint);
  const bodySensorRef = (0, import_react26.useRef)();
  ...
  const pointToMove = (delta, slopeAngle2, movingObjectVelocity2, functionKeyDown2) => {
    ...
    if (moveToPoint) {
      ...
      if (isModeFixedCamera)
        pivot.rotation.y = MathUtils.lerp(pivot.rotation.y, modelEuler.y, fixedCamRotMult * delta * 3);
      if (characterRef.current) {
  ...
  return import_react26.default.createElement(
    RigidBody,
    {
      ...
      onContactForce: (e4) => bodyContactForce.set(e4.totalForce.x, e4.totalForce.y, e4.totalForce.z),
    ...
    isModePointToMove && import_react26.default.createElement(
      CylinderCollider,
      {
        ref: bodySensorRef,
        sensor: true,
    ...
    import_react26.default.createElement("group", { ref: characterModelRef, userData: { camExcludeCollision: true } }, import_react26.default.createElement(
      "mesh",
      {
        position: [
          rayOriginOffest.x,
      ...
      import_react26.default.createElement("boxGeometry", { args: [0.15, 0.15, 0.15] })
    ), children)
  );
};
var Ecctrl$1 = (0, import_react26.forwardRef)(Ecctrl);
export {
  EcctrlAnimation,
  EcctrlJoystick,
  Ecctrl$1 as default,
